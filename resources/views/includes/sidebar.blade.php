        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li class="active"><a href="{{url('/')}}"><i class="ti-home"></i> Dashboard </a></li>	
                   
                    
                    <!-- <li><a href="app-profile.html"><i class="ti-user"></i> Profile</a></li> -->

                    <li><a href="{{route('enroll-view')}}"><i class="ti-export"></i> Enroll Staff</a></li>

                    <li><a href="{{url('performance')}}"><i class="ti-plus"></i> Enter Performance</a></li>
                    
                    <li><a href="#" data-toggle="modal" data-target="#memomodal" data-whatever="@fat"><i class="ti-bell"></i> Memo</a></li>

                    <li><a href="#" data-toggle="modal" data-target="#leavemodal" data-whatever="@fat"><i class="ti-pencil-alt2"></i> Leave Manager</a></li>

                    <li><a href="{{url('appraisal')}}"><i class="ti-comment-alt"></i> Manage Appraisal</a></li>

                     <li><a href="#"><i class="ti-layers"></i> Manage Staff</a></li> 
