...
<head>
    ...
    <meta name="webcam-link" content="{{ url('assets/js/webcam-js/src/webcam.js') }}">

    

    <title>Project :: Staff Appraisal</title>
    ...
    <link href="{{ url('assets/css/lib/mmc-chat.css') }}" rel="stylesheet" />
    <link href="{{ url('assets/css/lib/sidebar.css') }}" rel="stylesheet">
    <link href="{{ url('assets/css/lib/bootstrap.min.css') }}" rel="stylesheet">
    <link href="{{ url('assets/css/lib/simdahs.css') }}" rel="stylesheet">
